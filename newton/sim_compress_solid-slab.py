...
class ThighpadPokeTest:
    ...
    def create_model(self):
        ...
        ## ======= Add rectangular slab of roughly thigh-pad dimensions =======
        pad_width = 0.05
        pad_length = 0.05
        pad_thick = 0.014
        ...
        self.scene.add_soft_grid(
            pos = wp.vec3(-pad_width/2, -pad_length/2, pad_thick/2),
            rot = wp.quat_identity(),
            vel = wp.vec3(0.0, 0.0, 0.0),
            dim_x = cells_x,
            dim_y = cells_y,
            dim_z = cells_z,
            cell_x = pad_width/cells_x,
            cell_y = pad_length/cells_y,
            cell_z = pad_thick/cells_z,
            density = 1.0e3,
            k_mu = 1.0e5,
            k_lambda = 1.0e5,
            k_damp = 1e-4
    ...
    def step(self):
        time_period = 0.25
        z = 0.005 * np.sin(self.sim_time* 2*np.pi / time_period) + 0.087
